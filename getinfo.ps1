...
$hookUrl = 'https://discord.com/api/webhooks/1220856914905272320/dgiXQTKB-DW2PlaE_51esgfAWjxRUJyCChlN7Jkvp7MWJJ7eJQqyDyK-BTtpETGjYOVs'
...
#Set Language
Set-WinUserLanguageList fi-SE -Force